export default async function EditCategoryPage({
  ...
  params: Promise<{ locale: string; restaurantId: string; categoryId: string }>;
}>) {
  ...
  return (
    <div className="container mx-auto max-w-md px-4 py-10">
      <h1 className="text-2xl font-semibold">
        {base === "ru" ? "Редактировать категорию" : "Edit category"}
      </h1>
      <p className="mt-2 text-sm text-muted-foreground">ID: {categoryId}</p>
