...
var port = Number(process.env.PGPORT || 7000);
...
exports.AppDataSource =
  (_a = global.__gqm_data_source__) !== null && _a !== void 0
    ? _a
    : new typeorm_1.DataSource({
        ...
        synchronize: false,
        logging: false,
        entities: [Restaurant_1.Restaurant, Category_1.Category, Item_1.Item],
        migrations: [],
        entityPrefix: "gqm_",
      });
if (!global.__gqm_data_source__) {
  global.__gqm_data_source__ = exports.AppDataSource;
}
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          _a.label = 2;
        case 2:
          return [2 /*return*/, exports.AppDataSource];
      }
    });
  });
}
